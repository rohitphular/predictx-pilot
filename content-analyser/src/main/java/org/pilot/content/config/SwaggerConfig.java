...
public class SwaggerConfig {
    ...
    /* Below bean is a workaround to make swagger run on spring boot version 2.6.5
    * Its a open issue currently - https://github.com/springfox/springfox/issues/3462 */
    @Bean
